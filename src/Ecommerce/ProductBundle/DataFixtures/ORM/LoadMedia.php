...
class LoadMedia extends AbstractFixture implements OrderedFixtureInterface
{
  public function load(ObjectManager $manager)
  {
    ...
    $media4 = new media;
    $media4->setPath('fixtures/Ordinateur.png');
    ...
    $media5 = new media;
    $media5->setPath('fixtures/Ordinateur.png');
    ...
    $media6 = new Media;
    $media6->setPath('fixtures/tv7.png');
    ...
    $media7 = new media;
    $media7->setPath('fixtures/tv8.png');
    ...
    $media8 = new media;
    $media8->setPath('fixtures/tv9.png');
    ...
    $media9 = new media;
    $media9->setPath('fixtures/tv8.png');
    ...
    $media10 = new media;
    $media10->setPath('fixtures/tv9.png');
